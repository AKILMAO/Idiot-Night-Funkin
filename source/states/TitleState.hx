...
class TitleState extends MusicBeatState
{
	...
	function easterEggData()
	{
		...
		{
			case 'FEMBOY':
				characterImage = 'femboy title';
				animationName = 'Femboy Title Bump';
				gfPosition.x += 210;
				gfPosition.y += 40;
				useIdle = true;
		}
	...
	override function beatHit()
	{
		...
		if(!closedState)
		{
			...
			switch (sickBeats)
			{
				...
				case 2:
					createCoolText(['Cool mod by'], 40);
				case 4:
					addMoreText('Katz', 40);
					addMoreText('Mauzy and Palad', 40);
				case 5:
					deleteCoolText();
				case 6:
					createCoolText(['Associated', 'with'], -40);
				case 8:
					addMoreText('Gay sex', -40);
					ngSpr.visible = true;
				case 9:
					deleteCoolText();
					ngSpr.visible = false;
	...
	function skipIntro():Void
	{
		if (!skippedIntro)
		{
			...
			if (playJingle) //Ignore deez
			{
				...
				{
					case 'FEMBOY':
						FlxG.sound.play(Paths.sound('JingleFemboy'));
